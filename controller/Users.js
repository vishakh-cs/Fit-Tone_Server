...
export const fetchAllWorkouts = async(req, res, next) => {
  ...
  try {
    ...
    // Calculate total reps, today's time spent, and total time spent
    let totalReps = 0;
    ...
    workouts.forEach(workout => {
      ...
      totalTimeSpent += workout.duration;
      if (workout.date >= todayStart && workout.date <= todayEnd) {
        todayTimeSpent += workout.duration;
      }
    });
